...
class SceneNode {
    ...
    calculateWorldTransformation() {
        ...
        let hierarchy = this.getTransformationHierarchy( [] ) // leaf -> root

        // create the compound world transformation by multiplying Root -> Leaf
        world = mat4.identity(mat4.create())
        for (let i = hierarchy.length - 1; i >= 0; i--)
            mat4.multiply(world, world, hierarchy[i])
